...
<<StatPhosphatePreCO2, echo=TRUE, results='markup'>>=
@

%<<StatPhosphatePreCO2Smmry, echo=TRUE, results='markup'>>=
%@
...
<<StatPhosphatePostCO2, echo=TRUE, results='markup'>>=
@

%<<StatPhosphatePostCO2Smmry, echo=TRUE, results='markup'>>=
%@
