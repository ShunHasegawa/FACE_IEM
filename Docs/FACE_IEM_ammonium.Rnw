...
%% Stats %%
<<ReadScriptNH, echo=FALSE, cache=FALSE, include=FALSE>>=
...
<<StatAmmoniumPreCO2, echo=TRUE, results='markup'>>=
@

%<<StatAmmoniumPreCO2Smmry, echo=TRUE, results='markup'>>=
%@
...
<<StatAmmoniumPostCO2, echo=TRUE, results='markup'>>=
@

%<<StatAmmoniumPostCO2Smmry, echo=TRUE, results='markup'>>=
%@
