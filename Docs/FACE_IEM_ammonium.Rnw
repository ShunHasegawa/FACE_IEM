...
\includegraphics[width=6in]{../output//figs//FACE_IEM_CO2Trt_Ammonium.pdf}
...
<<Stat_FACE_IEM_Ammonium_postCO2_withSoilVar_Smmry, echo=TRUE, results='markup'>>=
@
...
\includegraphics[width=6in]{../output//figs/FACE_IEM_Ring_Ammonium.pdf}
